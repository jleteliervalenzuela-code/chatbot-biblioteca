...
CONTACTOS_SEDES = {
    "alameda": {
        ...
        "correo": None, "fonos": ["+56 2 23540342"], "whatsapp": None,
...
TOOLS_CHATBOT = [
    ...
    },
    {
        ...
        "description": (
            "Consulta EN VIVO las copias físicas disponibles de un libro (por su catkey) y en qué "
            "sedes están AHORA. Úsala cuando el estudiante quiera la copia física o pregunte si está "
            "en su sede. Requiere el catkey que devolvió buscar_libro."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
                "catkey": {
                    "type": "string",
                    "description": "El catkey del libro (lo devuelve buscar_libro)",
                }
            },
            "required": ["catkey"],
        },
    },
    {
        ...
        "description": (
            ...
            "Acepta el código del ramo (ej: MAT2110, TDA6501) o el nombre de la asignatura. "
            "Si el estudiante aún no da código ni nombre, pídeselo antes de llamarla."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
                "codigo_o_nombre": {
                    "type": "string",
                    "description": "Código del ramo (ej. TDA6501) o nombre de la asignatura",
                }
            },
...
def ejecutar_herramienta(nombre, args):
    ...
    try:
        ...
        if nombre == "ver_disponibilidad":
            ...
            if not catkey:
                return "Catkey invalido. Primero usa buscar_libro para obtenerlo."
        ...
        if nombre == "bibliografia_asignatura":
            ...
            if estado == "varias":
                return formato_varias(datos)
            return ("Esa asignatura no aparece en el indice de bibliografias. Pide el CODIGO exacto "
                    "del ramo (aparece en el aula virtual, ej. MAT2110). NO inventes bibliografia.")
