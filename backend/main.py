...
def _contexto_busqueda_libro(historial):
    ...
    detalles = ilsws.buscar_y_detallar(termino_busqueda, indice="TITLE", max_resultados=8)
    if not detalles:
        detalles = ilsws.buscar_y_detallar(termino_busqueda, indice="GENERAL", max_resultados=8)
